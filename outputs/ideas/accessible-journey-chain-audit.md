...
**Pitch.** Identify where a nominally accessible journey fails between sidewalk, terminal, gangway, vessel and clinic.
...
A wheelchair-ready vessel is insufficient if a curb, gangway or terminal blocks the trip. Disability groups, councils and operators need end-to-end evidence.
...
**Maldives evidence and confidence:** [RTL](https://www.rtl.mv/) has route information and [MTCC](https://mtcc.mv/wp-content/uploads/2024/06/Annual-Report-2023-2.pdf) reports access improvements, but an end-to-end audited barrier map is **not verified**. Confidence: medium on documented features; low on absence. Do not infer a trip is accessible from vessel type alone.

## Prototype interaction

Walk-and-ferry map with audit points, barrier type, photo evidence and route segments; toggle one ramp repair to show newly connected destinations.

## Data plan

**Available now / collectable by the team:** [OpenStreetMap](https://www.openstreetmap.org/) paths and public [RTL](https://www.rtl.mv/) stops; team-collected opt-in, ground-checked audit of a small Greater Malé corridor (curb height, ramp slope, clear width, surface, gangway status, timestamp), collected during fieldwork. Refresh pilot once.
...
**Geographic coverage:** Pilot — one Greater Malé corridor; later terminals and access paths nationwide.
